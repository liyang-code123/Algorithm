...
public class VendingMachineImpl implements VendingMachine{
    ...
    @Override
    public int selectItemGetPrice(Item item) throws SoldOutException {
    ...
    @Override
    public Pair<Item, List<Coin>> collectItemAndChange() throws NotSufficientCoinException, NotFullyPaidException {
        Item item = collectItem();
        totalSales = totalSales + currentItem.getPrice();

        List<Coin> change = collectChange();
        return new Pair<Item, List<Coin>>(item, change);
    }
    ...
    private Item collectItem() throws NotSufficientCoinException, NotFullyPaidException{
        if(isFullyPaid()) {
            ...
            throw new NotSufficientCoinException("Not Sufficient change in main.java.Inventory.");
        }
    ...
    private List<Coin> collectChange() throws NotSufficientCoinException {
    ...
    @Override
    public List<Coin> refund() throws NotSufficientCoinException{
    ...
    @Override
    public void setItemInventory(Item item, int quantity) throws IllegalArgumentException{
        if (quantity < 0) {
    ...
    @Override
    public int getItemInventory(Item item) {
